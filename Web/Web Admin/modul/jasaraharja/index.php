...
<html lang="en">
	<head>
		...
		<meta charset="utf-8" />
		<title>Server Admin Jasaraharja</title>
 ...
 <li>
    ...
    //                  while ($Data = mysql_fetch_array($tampil)) { 
				// 	 $jml = $Data["jumlah"];}
					  ...
					  $sql2 = "SELECT COUNT(*) AS jumlah2 FROM gbr WHERE  tipe='berita'";
					...
					<li class="">
						...
						<ul class="submenu">
							...
							<li class="">
								...
								<a href="?page=wanita">
									<i class="menu-icon fa fa-caret-right"></i>
									Data Penerima Santunan <?php echo $jml3;?>
								</a>
