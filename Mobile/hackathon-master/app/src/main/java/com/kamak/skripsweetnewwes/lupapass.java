...
public class lupapass extends AppCompatActivity {
    ...
    private String url = Server.URL+"cekuser.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnname.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent=new Intent(lupapass.this,isiname.class);
    ...
    private void cek(final String username) {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (success == 1) {
                        ...
                        Intent intent = new Intent(lupapass.this, isipass.class);
