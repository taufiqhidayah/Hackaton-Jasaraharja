...
$query1=mysql_query("insert into reg_siswa values('$id_sub','$id_kelas','$id_siswa','$abs')");
	...
	$update=mysql_query("update gbr set nik='$nik',telp='$notelp', nm_korban='$nmkorban', alamat_korban='$alamat', kondisi='$nama',gambar_id='$nama_file_unik',gambar_struk='$nama_file_unik2'
								...
								<div class="row">
										...
										<div>
											  <table class="table table-striped table-bordered table-hover" id="dataTables-example">
												...
												$tampil1=mysql_query("select * from gbr WHERE  tipe='berita'");
