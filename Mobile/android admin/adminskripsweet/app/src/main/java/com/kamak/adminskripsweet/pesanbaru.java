...
public class pesanbaru extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener  {
    ListView list;
    ...
    private static String url_list   = "http://noer.co.id/webservice/pesanbaru.php?offset=";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                Intent intent = new Intent(pesanbaru.this, DetailNews.class);
        ...
        adapter = new NewsAdapter(pesanbaru.this, newsList);
