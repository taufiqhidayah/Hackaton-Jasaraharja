...
public class DetailNews extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener {
    ...
    private static final String url_edit = Server.URL + "url_edit.php";
        ...
        btnkirim.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (mapIntent.resolveActivity(getPackageManager()) != null) {
                    ...
                    Toast.makeText(DetailNews.this, "Google Maps Belum Terinstal. Install Terlebih dahulu.",
    ...
    private void updateEmployee(){
        ...
        class UpdateEmployee extends AsyncTask<Void,Void,String>{
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loading = ProgressDialog.show(DetailNews.this,"Updating...","Wait...",false,false);
            }
            ...
            protected String doInBackground(Void... params) {
                ...
                hashMap.put(TAG_ID,id_news);
                hashMap.put("tipe","proses");



                RequestHandler rh = new RequestHandler();

                String s = rh.sendPostRequest(url_edit,hashMap);
    ...
    public void onBackPressed() {
        ...
        Intent intent = new Intent(DetailNews.this, pesanbaru.class);
