...
public class uploadselesai extends AppCompatActivity {
    Intent intent;
    Uri fileUri;
    Button buttonChoose;
    ...
    private static final String TAG = uploadselesai.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        id = getIntent().getStringExtra(TAG_IDuser);
        ...
        keterangan = getIntent().getStringExtra(TAG_KETERANGAN);
        GPSTracker gps = new GPSTracker(uploadselesai.this);
    ...
    private void selectImage() {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(uploadselesai.this);
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, UPLOAD_URL,
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if (success == 1) {
                                ...
                                Toast.makeText(uploadselesai.this, jObj.getString(TAG_MESSAGE), Toast.LENGTH_LONG).show();
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        //menampilkan toast
                        Toast.makeText(uploadselesai.this, error.getMessage().toString(), Toast.LENGTH_LONG).show();
            ...
            protected Map<String, String> getParams() {
                ...
                params.put(KEY_NAME, keterangan);
    ...
    private void kosong() {
        ...
        Intent intent = new Intent(uploadselesai.this, MainActivity.class);
