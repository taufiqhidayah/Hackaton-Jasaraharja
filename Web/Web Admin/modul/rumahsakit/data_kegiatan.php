...
?>	
                ...
                <div class="col-lg-6">
                    ...
                    <div class="alert alert-danger text-center">
                      ...
                      <a href="?page=data_siswa"><font color="red"> <?php echo "Data Korban Belum Ditangani";?> orang</font></a>
                ...
                <div class="col-lg-6">
                    <div class="alert alert-success text-center">
                      ...
                      <a href="?page=wanita"><font color="Green"><?php echo "Sudah Ditangani";?> orang</font></a>
                    </div>
                </div>
                ...
                <!--end quick info section -->
										...
										<div>
											  <table class="table table-striped table-bordered table-hover" id="dataTables-example">
												...
												$tampil1=mysql_query("select * from gbr");
												...
												?>
													<tr>
														...
														<td><img src="$r['path']"width="100" height="100"</td>
