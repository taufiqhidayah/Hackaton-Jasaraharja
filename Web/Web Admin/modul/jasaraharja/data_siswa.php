...
$query1=mysql_query("insert into reg_siswa values('$id_sub','$id_kelas','$id_siswa','$abs')");
	...
	$update=mysql_query("update gbr set kondisi='$nama'
								...
								<div class="row">
										...
										<div>
											  <table class="table table-striped table-bordered table-hover" id="dataTables-example">
												...
												$tampil1=mysql_query("select * from gbr WHERE kondisi='selesai' AND tipe='kecelakaan'");
												...
												?>
													<tr>
															...
															<td><?php echo $r['nm_korban'];?></td>
														
														
														<td><?php echo $r['alamat_korban'];?></td>
														
														<td><?php echo $r['ket_korban'];?></td>
												...
												<div class="modal-body">
													<div class="form-body">
														...
														<div class="form-group">
															...
															<input type="text" class="form-control" name="nama"  value="'.$r['nm_korban'].'">
														</div>
															<div class="form-group">
															<label> Alamat Korban</label>
															<input type="text" class="form-control" name="nama"  value="'.$r['alamat_korban'].'">
														</div>
														
															<div class="form-group">
															<label> NIK Korban</label>
															<input type="text" class="form-control" name="nama"  value="'.$r['nik'].'">
														</div>
														
															<div class="form-group">
															<label> Nomor Telpon </label>
															<input type="text" class="form-control" name="nama"  value="'.$r['notelp'].'">
														</div>
														
															<div class="form-group">
															<label>Keterangan Korban </label>
															<input type="text" class="form-control" name="nama"  value="'.$r['ket_korban'].'">
														</div>
